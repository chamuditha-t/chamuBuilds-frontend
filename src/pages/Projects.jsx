...
export default function Projects() {
  ...
  return (
    <div style={{ backgroundColor: 'red', minHeight: '100-vh', color: 'white', padding: '100px' }}>
      <h1>THIS IS THE PROJECTS PAGE</h1>
      <p>If you see this red screen, Routing is working!</p>
      <a href="/#/" style={{ color: 'yellow' }}>Go Back Home</a>
    </div>
  );
}
